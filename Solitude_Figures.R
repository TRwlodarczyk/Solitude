...

{
  ...
  dt <- read.delim("Solitude2022_Predicted_Cooks.txt")
  dt <- subset(dt, Site != 'NATURAL')
...

{
  ...
  Cu <- ggplot(dt_selected, aes(x = reorder(Scientific_Name, Predicted_Cu_M3, FUN = median),
                                y = Predicted_Cu_M3, Sceintific_Name = Scientific_Name)) +
  ...
  Fe <- ggplot(dt_selected, aes(x = reorder(Scientific_Name, Predicted_Fe_M3, FUN = median),
                                y = Predicted_Fe_M3, Sceintific_Name = Scientific_Name)) +
  ...
  Se <- ggplot(dt_selected, aes(x = reorder(Scientific_Name, Predicted_Se_M3, FUN = median),
                                y = Predicted_Se_M3, Sceintific_Name = Scientific_Name)) +
    geom_boxplot(linewidth=0.3) +
    geom_point(aes(shape = Plot), size = 2.5) +  # Adjust the size parameter here
    scale_shape_manual(values = c(21, 21, 21, 4)) +
  ...
  Re <- ggplot(dt_selected, aes(x = reorder(Scientific_Name, Predicted_Re_M3, FUN = median),
                                y = Predicted_Re_M3, Sceintific_Name = Scientific_Name)) +
    geom_boxplot(linewidth=0.3) +
    geom_point(aes(shape = Plot), size = 2.5) +  # Adjust the size parameter here
    scale_shape_manual(values = c(21, 21, 21, 4)) +
    scale_y_continuous(limits = c(0, 100), breaks = seq(0, 100, by = 20)) +
  ...
  Mn <- ggplot(dt_selected, aes(x = reorder(Scientific_Name, Predicted_Mn_M3, FUN = median),
                                y = Predicted_Mn_M3, Sceintific_Name = Scientific_Name)) +
    geom_boxplot(linewidth=0.3) +
    geom_point(aes(shape = Plot), size = 2.5) +  # Adjust the size parameter here
    scale_shape_manual(values = c(21, 21, 21, 4)) +
  ...
  Zn <- ggplot(dt_selected, aes(x = reorder(Scientific_Name, Predicted_Zn_M3, FUN = median),
                                y = Predicted_Zn_M3, Sceintific_Name = Scientific_Name)) +
    geom_boxplot(linewidth=0.3) +
    geom_point(aes(shape = Plot), size = 2.5) +  # Adjust the size parameter here
    scale_shape_manual(values = c(21, 21, 21, 4)) +
    scale_y_continuous(limits = c(0, 100), breaks = seq(0, 100, by = 20)) +
...

{
  ...
  cor.test(dt$Cu_ICP, dt$Cu_PXRF, method="spearman")
  cor.test(dt$Cu_ICP, dt$Predicted_Cu_M3, method="spearman")
  
  p <- ggplot(dt, aes(x = Cu_PXRF, y = Cu_ICP)) +
    geom_point(color = "#003f5c", size=2.5, stroke=0.6, shape=1) +
    geom_point(aes(x = Predicted_Cu_M3, y = Cu_ICP), color = "#AD0B0B", size=2.5, stroke=0.6, shape=3) + # New points
    geom_smooth(aes(x = Cu_PXRF, y = Cu_ICP), method = "lm", se = FALSE, color = "#003f5c", linetype = "solid", size=0.65) +   # Regression line for the first model
    geom_smooth(aes(x = Predicted_Cu_M3, y = Cu_ICP), method = "lm", se = FALSE, color = "#AD0B0B", linetype = "solid", size=0.65) +  # Regression line for the second model
  ...
  #Fe
  cor.test(dt$Fe_ICP, dt$Fe_PXRF, method="spearman")
  cor.test(dt$Fe_ICP, dt$Predicted_Fe_M3, method="spearman")
  
  p <- ggplot(dt, aes(x = Fe_PXRF, y = Fe_ICP)) +
    geom_point(color = "#003f5c", size=2.5, stroke=0.6, shape=1) +
    geom_point(aes(x = Predicted_Fe_M3, y = Fe_ICP), color = "#AD0B0B", size=2.5, stroke=0.6, shape=3) + # New points
    geom_smooth(aes(x = Fe_PXRF, y = Fe_ICP), method = "lm", se = FALSE, color = "#003f5c", linetype = "solid", size=0.65) +   # Regression line for the first model
    geom_smooth(aes(x = Predicted_Fe_M3, y = Fe_ICP), method = "lm", se = FALSE, color = "#AD0B0B", linetype = "solid", size=0.65) +  # Regression line for the second model
    geom_abline(intercept = 0, slope = 1, color = "darkgrey",linetype = "dashed", linewidth=0.65) +
  ...
  #Zn
  cor.test(dt$Zn_ICP, dt$Predicted_Zn_M3, method="spearman")
  cor.test(dt$Zn_ICP, dt$Zn_PXRF, method="spearman")
  
  p <- ggplot(dt, aes(x = Zn_PXRF, y = Zn_ICP)) +
    geom_point(color = "#003f5c", size=2.5, stroke=0.6, shape=1) +
    geom_point(aes(x = Predicted_Zn_M3, y = Zn_ICP), color = "#AD0B0B", size=2.5, stroke=0.6, shape=3) + # New points
    geom_smooth(aes(x = Zn_PXRF, y = Zn_ICP), method = "lm", se = FALSE, color = "#003f5c", linetype = "solid", size=0.65) +   # Regression line for the first model
    geom_smooth(aes(x = Predicted_Zn_M3, y = Zn_ICP), method = "lm", se = FALSE, color = "#AD0B0B", linetype = "solid", size=0.65) +  # Regression line for the second model
    geom_abline(intercept = 0, slope = 1, color = "darkgrey",linetype = "dashed", linewidth=0.65) +
  ...
  # Mn
  cor.test(dt$Mn_ICP, dt$Mn_PXRF, method="spearman")
  cor.test(dt$Mn_ICP, dt$Predicted_Mn_M3, method="spearman")
  
  p <- ggplot(dt, aes(x = Mn_PXRF, y = Mn_ICP)) +
    geom_point(color = "#003f5c", size=2.5, stroke=0.6, shape=1) +
    geom_point(aes(x = Predicted_Mn_M3, y = Mn_ICP), color = "#AD0B0B", size=2.5, stroke=0.6, shape=3) + # New points
    geom_smooth(aes(x = Mn_PXRF, y = Mn_ICP), method = "lm", se = FALSE, color = "#003f5c", linetype = "solid", size=0.65) +   # Regression line for the first model
    geom_smooth(aes(x = Predicted_Mn_M3, y = Mn_ICP), method = "lm", se = FALSE, color = "#AD0B0B", linetype = "solid", size=0.65) +  # Regression line for the second model
    geom_abline(intercept = 0, slope = 1, color = "darkgrey",linetype = "dashed", linewidth=0.65) +
  ...
  #Re
  cor.test(dt$Re_ICP, dt$Re_PXRF, method="spearman")
  cor.test(dt$Re_ICP, dt$Predicted_Re_M3, method="spearman")
  
   p <- ggplot(dt, aes(x = Re_PXRF, y = Re_ICP)) +
    geom_point(color = "#003f5c", size=2.5, stroke=0.6, shape=1) +
    geom_point(aes(x = Predicted_Re_M3, y = Re_ICP), color = "#AD0B0B", size=2.5, stroke=0.6, shape=3) + # New points
    geom_smooth(aes(x = Re_PXRF, y = Re_ICP), method = "lm", se = FALSE, color = "#003f5c", linetype = "solid", size=0.65) +   # Regression line for the first model
    geom_smooth(aes(x = Predicted_Re_M3, y = Re_ICP), method = "lm", se = FALSE, color = "#AD0B0B", linetype = "solid", size=0.65) +  # Regression line for the second model
    geom_abline(intercept = 0, slope = 1, color = "darkgrey",linetype = "dashed", linewidth=0.65) +
  ...
  #Se
  cor.test(dt$Se_ICP, dt$Se_PXRF, method="spearman")
  cor.test(dt$Se_ICP, dt$Predicted_Se_M3, method="spearman")
  
  p <- ggplot(dt, aes(x = Se_PXRF, y = Se_ICP)) +
    geom_point(color = "#003f5c", size=2.5, stroke=0.6, shape=1) +
    geom_point(aes(x = Predicted_Se_M3, y = Se_ICP), color = "#AD0B0B", size=2.5, stroke=0.6, shape=3) + # New points
    geom_smooth(aes(x = Se_PXRF, y = Se_ICP), method = "lm", se = FALSE, color = "#003f5c", linetype = "solid", size=0.65) +   # Regression line for the first model
    geom_smooth(aes(x = Predicted_Se_M3, y = Se_ICP), method = "lm", se = FALSE, color = "#AD0B0B", linetype = "solid", size=0.65) +  # Regression line for the second model
    geom_abline(intercept = 0, slope = 1, color = "darkgrey",linetype = "dashed", linewidth=0.65) +
...
# Bars form, elements, plots different

{
  ...
  dt_summary <- dt %>%
    group_by(Plot, Form) %>%
    summarize(Mean = mean(Predicted_Cu_ICP), SD = sd(Predicted_Cu_ICP)/sqrt(n()), .groups = 'drop')
  ...
  Cu_plant <- ggplot(dt_summary, aes(x = forcats::fct_rev(Plot), y = Mean, fill = Plot)) +
    ...
    theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
          ...
          strip.background = element_rect(fill = "#d6d4b2", colour = "black")) # Custom strip background color
  ...
  dt_summary <- dt %>%
    group_by(Plot, Form) %>%
    summarize(Mean = mean(Predicted_Se_ICP), SD = sd(Predicted_Se_ICP)/sqrt(n()), .groups = 'drop')
  ...
  dt_summary <- dt %>%
    group_by(Plot, Form) %>%
    summarize(Mean = mean(Predicted_Re_ICP), SD = sd(Predicted_Re_ICP)/sqrt(n()), .groups = 'drop')
  ...
  dt_summary <- dt %>%
    group_by(Plot, Form) %>%
    summarize(Mean = mean(Predicted_Zn_ICP), SD = sd(Predicted_Zn_ICP)/sqrt(n()), .groups = 'drop')
  ...
  dt_summary <- dt %>%
    group_by(Plot, Form) %>%
    summarize(Mean = mean(Predicted_Mn_ICP), SD = sd(Predicted_Mn_ICP)/sqrt(n()), .groups = 'drop')
  ...
  dt_summary <- dt %>%
    group_by(Plot, Form) %>%
    summarize(Mean = mean(Predicted_Fe_ICP), SD = sd(Predicted_Fe_ICP)/sqrt(n()), .groups = 'drop')
